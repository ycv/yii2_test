                    ...
                    <ul class="goal-progress">
                        <li>
                            <div class="prog-avatar">
                                <img src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/images/') ?>photos/user1.png" alt=""/>
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/images/') ?>photos/user2.png" alt=""/>
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/images/') ?>photos/user3.png" alt=""/>
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/images/') ?>photos/user4.png" alt=""/>
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/images/') ?>photos/user5.png" alt=""/>
                            </div>
                            <div class="details">
                                <div class="title">
                                    <a href="#">Hoffman Doe</a> - Support
                ...
                <div class="panel-body">
                    <div class="media usr-info">
                        <a href="#" class="pull-left">
                            <img class="thumb" src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/images/') ?>photos/user2.png" alt=""/>
                        </a>
...
<script src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/js/') ?>jquery-migrate-1.2.1.min.js"    type="text/javascript" ></script>
<script src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/js/') ?>bootstrap.min.js"    type="text/javascript" ></script>
<script src="<?= Yii::$app->request->hostInfo ?><?= Yii::getAlias('@web/statics/user/js/') ?>modernizr.min.js"    type="text/javascript" ></script>
